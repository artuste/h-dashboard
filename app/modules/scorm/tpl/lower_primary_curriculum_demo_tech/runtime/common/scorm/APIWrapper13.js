 ...
 *    Ustawiona wartoœæ ma wp³yw wy³¹cznie na wartoœæ cmi.core.entry w nastêpnej sesji u¿ytkownika z danym SCO.
 *    "" - oznacza normalne zakoñczenie SCO (nie ma te¿ ¿adnego wp³ywu na wartoœæ cmi.suspend_data w nastêpnej sesji)
 *
 * SCORM 1.3: "" (empty), "time-out", "suspend", "logout" (deprecated), "normal"
 *    Ustawiona wartoœæ ma wp³yw na cmi.entry oraz cmi.suspend_data w nastepnej sesji u¿ytkownika z danym SCO.
 *    "" - oznacza nieokreœlon¹ przyczynê zakoñczenia pracy z SCO. W nastêpnej sesji wartoœci wszystkich zmiennych bêd¹ puste.
 *         W szczególnoœci - cmi.suspend_data bêdzie pustym stringiem.
 *    "suspend" - oznacza przerwanie pracy z SCO z zamiarem powrócenia do niej. Jest to JEDYNA wartoœæ cmi.exit, która
 *         spowoduje odtworzenie przez LMS wartoœci cmi.suspend_data w nastêpnej sesji!!!
 */
